...
CREATE SEQUENCE public.defaults_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.phone_calls_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN id
SET DEFAULT nextval('public.defaults_id_seq'::regclass);
--
...
ALTER COLUMN id
SET DEFAULT nextval('public.phone_calls_id_seq'::regclass);
--
